...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginBox = __webpack_require__(223);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var SignIn = __webpack_require__(224);
	var SignUp = __webpack_require__(229);
	var SignOut = __webpack_require__(230);
	...
	var LoginBox = React.createClass({
	  ...
	  fetchUser: function fetchUser() {
	    ...
	    get(this.props.url + "users.json").then(function (response) {
	  ...
	  render: function render() {
	    ...
	    if (this.state.currentUser) {
	      mainDiv = React.createElement(
	        ...
	        React.createElement(SignOut, { url: this.props.url + "users/sign_out.json", onSignOut: this.setUser })
	      );
	    }
	    return React.createElement(
	      'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Show = __webpack_require__(232);
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.state.shows.filter(function (show) {
	          return (show.title + ' ' + show.description).toUpperCase().indexOf(_this2.state.searchQuery.toUpperCase()) >= 0;
	        }).map(function (show) {
	          return React.createElement(Show, _extends({}, show, { key: show.programmeID }));
	        })
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Show = function Show(props) {
	  return React.createElement(
	    'div',
	    { className: 'show' },
	    React.createElement('img', { src: 'images/' + props.image, className: 'show-image' }),
	    React.createElement(
	      'div',
